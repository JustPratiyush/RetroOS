...
- **No external widget services** — mail uses a custom Nodemailer backend.
...
| `js/mail.js` | Mail inbox data + compose + backend send logic |
...
| `mail.js` | `inboxEmails` data, `renderInbox`, `selectEmail`, `MailService`, `setMailView` |
